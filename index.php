    ...
    <div class="slide-container swiper">
      <div class="slide-content swiper-wrapper">
        <div class="overlay swiper-slide">
          <img src="./img/show-case-1.jpg" alt="Showcase Morocco Image 1" />
        ...
        <div class="overlay swiper-slide">
          <img src="./img/show-case-2.jfif" alt="Showcase Morocco Image 2" />
          <div class="img-overlay">
            <p>Let's Travel Around Morocco With Us</p>
            <h2><span>Discover</span> Morocco</h2>
            <h2>With Our Guide</h2>
        ...
        <div class="overlay swiper-slide">
          <img src="./img/show-case-3.jpg" alt="Showcase Morocco Image 3" />
          <div class="img-overlay">
            <p>Let's Travel Around Morocco With Us</p>
    ...
    <div class="container">
      <div class="about-content-wrapper">
        ...
        <div class="agency-right-side">
          <div class="img">
            <img src="./img/Northern+Morocco.jfif" alt="Morocco Landscape" />
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="choose-wrapper">
        <div class="img-left-side">
          <div class="lg-img">
            <img src="./img/_Best-Restaurants-Marrakesh-Comptoir-Darna.webp" alt="Marrakech" />
        ...
        <div class="img-right-side">
          <div class="lg-img">
            <img src="./img/15-days-tour-from-Marrakech-marrakech-700x400.webp" alt="Desert Tour" />
            <div class="img-content">
              <h2>Sahara Desert</h2>
              <div class="hidden-content">
      ...
      <div class="row-wise-img">
        <div class="lg-img">
          <img src="./img/casablanca-mosque.jpg" alt="Casablanca" />
          <div class="img-content">
            <h2>Casablanca</h2>
            <div class="hidden-content">
        ...
        <div class="lg-img">
          <img src="./img/morocco-tangier.jpg" alt="Tangier" />
          <div class="img-content">
            <h2>Tangier</h2>
            <div class="hidden-content">
        ...
        <div class="lg-img">
          <img src="./img/Rabat-1-scaled.webp" alt="Rabat" />
          <div class="img-content">
            <h2>Rabat</h2>
            <div class="hidden-content">
              <span><i class="fa fa-clock"></i> 1-3 days</span>
        ...
        <div class="destination-swiper swiper2">
          <div class="swiper-wrapper">
            <div class="carousel swiper-slide">
              <img src="./img/Marrakech-jamaa-lafna.webp" alt="Jemaa el-Fnaa" />
            ...
            <div class="carousel swiper-slide">
              <img src="./img/sahara.jfif" alt="Sahara Desert" />
              <div class="carousel-img-overlay">
                <div class="img-content">
            ...
            <div class="carousel swiper-slide">
              <img src="./img/chefchaouen.jpg" alt="Chefchaouen" />
              <div class="carousel-img-overlay">
                <div class="img-content">
            ...
            <div class="carousel swiper-slide">
              <img src="./img/agadir.jpg" alt="Agadir" />
              <div class="carousel-img-overlay">
                <div class="img-content">
            ...
            <div class="carousel swiper-slide">
              <img src="./img/meknes.jpg" alt="Meknes" />
              <div class="carousel-img-overlay">
                <div class="img-content">
            ...
            <div class="carousel swiper-slide">
              <img src="./img/essaouira-beach.jpg" alt="Essaouira" />
              <div class="carousel-img-overlay">
                <div class="img-content">
      ...
      <div class="travel-citys-wrapper">
        ...
        <div class="slider-content-wrapper">
          <div class="city-swiper swiper3">
            <div class="swiper-wrapper">
              <div class="carousel swiper-slide">
                <img src="./img/marrakech-riad.jpg" alt="Marrakech Riad" />
                <div class="carousel-img-overlay">
                  <div class="img-content">
              ...
              <div class="carousel swiper-slide">
                <img src="./img/marrakech-desert.jpg" alt="Marrakech Desert" />
                <div class="carousel-img-overlay">
                  <div class="img-content">
              ...
              <div class="carousel swiper-slide">
                <img src="./img/atlas-mountains.jpg" alt="Atlas Mountains" />
                <div class="carousel-img-overlay">
                  <div class="img-content">
              ...
              <div class="carousel swiper-slide">
                <img src="./img/marrakech-garden.jpg" alt="Marrakech Garden" />
                <div class="carousel-img-overlay">
                  <div class="img-content">
      ...
      <div class="rabat-content">
        <div class="slider-content-wrapper">
          <div class="city-swiper swiper3">
            <div class="swiper-wrapper">
              <div class="carousel swiper-slide">
                <img src="./img/fez-medina.jpg" alt="Fez Medina" />
                <div class="carousel-img-overlay">
                  <div class="img-content">
              ...
              <div class="carousel swiper-slide">
                <img src="./img/fez-tanneries.jpg" alt="Fez Tanneries" />
                <div class="carousel-img-overlay">
                  <div class="img-content">
              ...
              <div class="carousel swiper-slide">
                <img src="./img/fez-palace.jpg" alt="Fez Royal Palace" />
                <div class="carousel-img-overlay">
                  <div class="img-content">
              ...
              <div class="carousel swiper-slide">
                <img src="./img/fez-day-trip.jpg" alt="Fez Day Trip" />
                <div class="carousel-img-overlay">
                  <div class="img-content">
